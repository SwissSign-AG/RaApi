...
public class ApiClient {
    ...
    private String basePath = "https://api.ra.pre.swisssign.ch";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.ra.pre.swisssign.ch",
      "Pre Production",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "https://api.ra.swisssign.ch",
      "Production",
      new HashMap<String, ServerVariable>()
    )
  ));
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/3.4.4/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.ra.pre.swisssign.ch
