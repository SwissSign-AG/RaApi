...
public class CertificateOrders {
  ...
  public CertificateOrders data(@javax.annotation.Nonnull List<CertificateOrder> data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(@javax.annotation.Nonnull List<CertificateOrder> data) {
    this.data = data;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CertificateOrders
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CertificateOrders.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CertificateOrders.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CertificateOrders` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        CertificateOrder.validateJsonElement(jsonArraydata.get(i));
      };
  }
