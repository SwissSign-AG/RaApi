...
class TestApiRegistrationApi(unittest.TestCase):
    ...
    def test_add_certificate_order_additional_recipients(self):
    ...
    def test_delete_certificate_order_additional_recipients(self):
    ...
    def test_issue_certificate_v22(self):
    ...
    def test_list_certificate_order_additional_recipients(self):
    ...
    def test_publish_certificate(self):
    ...
    def test_replace_certificate_order_tags(self):
    ...
    def test_search_paged_certificate_orders(self):
    ...
    def test_search_paged_clients(self):
    ...
    def test_unpublish_certificate(self):
