...
class ApiRegistrationApi(object):
    ...
    def issue_certificate(
        ...
        **kwargs
        ...
        >>> thread = api.issue_certificate(product_reference, async_req=True)
        >>> result = thread.get()
    ...
    def revoke_certificates(
        ...
        **kwargs
        ...
        >>> thread = api.revoke_certificates(async_req=True)
        >>> result = thread.get()


        Keyword Args:
            revocation_request ([RevocationRequest]): Certificate references to revoke. [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
