...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/2.3.12/python'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.add_certificate_order_additional_recipients  # this is an instance of the class Endpoint
        api_instance.add_certificate_order_additional_recipients()  # this invokes api_instance.add_certificate_order_additional_recipients.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.add_certificate_order_additional_recipients.callable or self.callable in this class
