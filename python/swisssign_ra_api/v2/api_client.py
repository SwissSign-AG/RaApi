...
from swisssign_ra_api.v2 import rest
from swisssign_ra_api.v2.configuration import Configuration
from swisssign_ra_api.v2.exceptions import ApiTypeError, ApiValueError, ApiException
from swisssign_ra_api.v2.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/2.0.213/python'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ApiRegistrationApi()
        api_instance.create_client_prevalidated_domains  # this is an instance of the class Endpoint
        api_instance.create_client_prevalidated_domains()  # this invokes api_instance.create_client_prevalidated_domains.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_client_prevalidated_domains.callable or self.callable in this class
