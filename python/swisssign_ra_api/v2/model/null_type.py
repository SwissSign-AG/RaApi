...
class NullType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """NullType - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): for adding nullability to a ref., must be one of ["null", ]  # noqa: E501

        Keyword Args:
            value (str): for adding nullability to a ref., must be one of ["null", ]  # noqa: E501
