...
def lazy_import():
    ...
    globals()['DNSOwnerCheck'] = DNSOwnerCheck
...
class ClientDNS(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'validation_method': (DNSOwnerCheck,),  # noqa: E501
    ...
    def _from_openapi_data(cls, uuid, domain, domain_unicode, validated, trusted_domain, validation_method, expired, random_value_time_expired, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            validation_method (DNSOwnerCheck):
    ...
    @convert_js_args_to_python_args
    def __init__(self, domain, trusted_domain, validation_method, *args, **kwargs):  # noqa: E501
        """ClientDNS - a model defined in OpenAPI
