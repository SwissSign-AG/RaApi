...
class AdditionalRecipient(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, email, recipient_type, language, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, email, recipient_type, language, *args, **kwargs):  # noqa: E501
        """AdditionalRecipient - a model defined in OpenAPI
