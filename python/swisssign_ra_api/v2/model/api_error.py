...
class APIError(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, uuid, error_code, error_messages, *args, **kwargs):  # noqa: E501
        """APIError - a model defined in OpenAPI

        Args:
            uuid (str): end user error UUID reference
    ...
    @convert_js_args_to_python_args
    def __init__(self, error_messages, *args, **kwargs):  # noqa: E501
        """APIError - a model defined in OpenAPI
