...
class RegistrationDocument(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, document_name, document, *args, **kwargs):  # noqa: E501
        """RegistrationDocument - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, document_name, document, *args, **kwargs):  # noqa: E501
        """RegistrationDocument - a model defined in OpenAPI
