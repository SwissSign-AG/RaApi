...
class JobType(ModelSimple):
    ...
    allowed_values = {
        ('value',): {
            ...
            'RAOAUTHORIZECERTIFICATEREVOKEJOB': "RAOAuthorizeCertificateRevokeJob",
            'PUBLISHCERTIFICATEORDERJOB': "PublishCertificateOrderJob",
            'SENDEMAILJOB': "SendEmailJob",
            'REVOKECERTIFICATEJOB': "RevokeCertificateJob",
        },
    }
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): Certificate Order Task Type., must be one of ["SubmitCertificateOrderJob", "CertificateRenewalValidationJob", "KeyValidationJob", "PreValidationParentJob", "GenerateTBSJob", "PolicyValidationJob", "CAACheckValidationJob", "DomainOwnerCheckValidationJob", "EndUserEmailValidationJob", "PreLintingCertificateJob", "PreIssueCertificateParentJob", "CTLogPrecertPublicationJob", "IssueCertificateJob", "PostIssueCertificateParentJob", "FinalizeIssueCertificateParentJob", "PostLintingCertificateJob", "PostPublishCertificateJob", "CTLogPublicationJob", "CertificateOrderAuthorizationJob", "NotifyIssuedCertificateJob", "NotifyRenewalCertificateJob", "UpdateRenewalCertificateJob", "RevokeRenewedCertificateJob", "NotifyRenewalP12CertificateJob", "NotifyRenewalHsmCertificateJob", "SetP12PinJob", "RAOAuthorizeCertificateRevokeJob", "PublishCertificateOrderJob", "SendEmailJob", "RevokeCertificateJob", ]  # noqa: E501
