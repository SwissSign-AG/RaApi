...
class RequestDeviceSerialNumber(BaseModel):
    """
    RequestDeviceSerialNumber
    """ # noqa: E501
    value: StrictStr = Field(description="Device Serial Number extension as defined in OID 1.3.6.1.4.1.43121.1.4.2.0.2 (UTF8String)")
